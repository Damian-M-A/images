...
Rectangle {
    ...
    Rectangle {
        ...
        GridLayout {
            anchors { top: lbltext.bottom; bottom: parent.bottom; left: parent.left; right: parent.right; margins: 20 }
            columns: 2
            columnSpacing: 15
            rowSpacing: 15
    ...
    Rectangle {
        id: rightContent
        anchors { top: parent.top; left: leftContent.right; right: parent.right; bottom: parent.bottom }
        color: "transparent"
        ...
        GridLayout {
            anchors { top: lblmetrics.bottom; left: parent.left; right: parent.right; bottom: parent.bottom; margins: 20 }
            columns: 2
            columnSpacing: 12
            rowSpacing: 12
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Column {
                                Text { text: "TEMP"; color: "#80ffffff"; font.pixelSize: 9; anchors.horizontalCenter: parent.horizontalCenter }
                                Text { 
                                    text: modelData.temp + "°C"
                                    color: "white"; font { pixelSize: 18; bold: true; family: "Monospace" } 
                            ...
                            Column {
                                Text { text: "PRES"; color: "#80ffffff"; font.pixelSize: 9; anchors.horizontalCenter: parent.horizontalCenter }
                                Text { 
                                    text: modelData.press
                                    color: "white"; font { pixelSize: 18; bold: true; family: "Monospace" }
                                    anchors.horizontalCenter: parent.horizontalCenter
                                }
                            }
